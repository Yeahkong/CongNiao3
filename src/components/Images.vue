    ...
    <div id="slider">
        <div class="back">
            <div class="sky">
                ...
                <div class="star glow eight"></div>
                <div class="star glow nine"></div>
                <div class="star glow ten"></div>
                <div class="star glow eleven"></div>
                <div class="star glow twelve"></div>
                <div class="moon">
            ...
            <div class="window" @mouseover="stop" @mouseleave="play">
                <ul class="container" :style="containerStyle">
                    <li>
                        <img :style="{width:imgWidth+'px'}" :src="sliders.img" alt="" :onerror="defaultImg">
                    </li>
...
<script>
    ...
    export default {
        ...
        computed:{
            defaultImg () {
                return 'this.src="'+ require('../../static/images/lunbo1.png') +'"'
            },
            containerStyle() {
                return {
            ...
            animate(des, direc, speed) {
                ...
                this.temp = window.setInterval(() => {
                    if ((direc === -1 && des < this.distance) || (direc === 1 && des > this.distance)) {
                        ...
                        window.clearInterval(this.temp)
                        this.distance = des
                        if (des < -5000) this.distance = -1000
                        if (des > -1000) this.distance = -5000
                    }
                }, 20)
            },
            jump(index) {
